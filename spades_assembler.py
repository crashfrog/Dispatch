...
def assemble(path, accession, fasta_file_name=None, callback=lambda s: None, update_callback=lambda d: None, debug=True, **kwargs):
	...
	d = {'assembly_version':'SPAdes v. 2.5.0',
		 'average_coverage':'',
		 'num_contigs':'',
		 'n50':'',
		 'num_bases':'',
	...
	try:
		...
		subprocess.check_call("{spades_exec}spades.py -t 8 -m 64 -1 {reads1} -2 {reads2} -o {temp_dir}".format(spades_exec=spades_exec, **kwargs), shell=True)
		
		update_callback({"k_value":'21,33,55'})
...
if __name__ == "__main__":
	...
	print assemble(path='/home/justin.payne', 
			 reads1='/shared/gn2/CFSANgenomes/CFSAN002097/CFSAN002097_01/CFSAN002097-01_S2_L001_R1_001.fastq', 
			 reads2='/shared/gn2/CFSANgenomes/CFSAN002097/CFSAN002097_01/CFSAN002097-01_S2_L001_R2_001.fastq', 
			 accession='CFSAN002097_01', 
			 callback=cb,
