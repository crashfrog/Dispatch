...
def trim(assembler=lambda d: None, reads1=None, reads2=None, trimmer_args="", callback=lambda s, t: None, **kwargs):
	"Sickle sliding-window error correction for Illumina reads."
	if trimmer_args:
	...
	subprocess.check_call("sickle {}{} {}".format(trimmer_args, reads1, temp_reads1), shell=True)
	...
	if reads2:
		...
		subprocess.check_call("sickle {}{} {}".format(trimmer_args, reads2, temp_reads2), shell=True)
...
if __name__ == "__main__":
	...
	bcb(trim(path='/home/justin.payne', 
			 assembler=worst_assembler.assemble,
